...
function pagenavi_bra_textdomain() {
	load_plugin_textdomain('wp-pagenavi_bra', 'pagenavi_bra.php');
}
...
function pagenavi_bra_init() {
	...
	$pagenavi_bra_options['pages_text'] = __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','wp-pagenavi_bra');
	$pagenavi_bra_options['current_text'] = '%PAGE_NUMBER%';
	$pagenavi_bra_options['page_text'] = '%PAGE_NUMBER%';
	$pagenavi_bra_options['first_text'] = __('&larr;; First','wp-pagenavi_bra');
	$pagenavi_bra_options['last_text'] = __('Last &rarr;','wp-pagenavi_bra');
	$pagenavi_bra_options['next_text'] = __('&rarr;','wp-pagenavi_bra');
	$pagenavi_bra_options['prev_text'] = __('&larr;','wp-pagenavi_bra');
	$pagenavi_bra_options['dotright_text'] = __('...','wp-pagenavi_bra');
	$pagenavi_bra_options['dotleft_text'] = __('...','wp-pagenavi_bra');
