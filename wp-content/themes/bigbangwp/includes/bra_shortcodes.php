...
class Brankic_shortcodes
{
    ...
    function filter_mce_plugin( $plugins ) {
        ...
        $plugins['shortcodes_options'] = BRANKIC_ROOT . '/includes/bra_shortcodes_options.js';
        return $plugins;
    }
}
...
*******************************************************************************************************************/
   ...
   return "<div class='section-title text-align-center'><h1 class='title'>$title</h1><p>$subtitle</p></div>";
}
...
*                                                                                                                  *
*******************************************************************************************************************/
    extract(shortcode_atts(array("title" => "Recent Work", "cat_id" => "", "no" => "-1", "show_filters" => "no", "columns" => "4", "shape" => ""), $atts));
    // The Query
    ...
    $html .=    '<li class="current"><a href="#" data-filter="*">' . __('All', BRANKIC_THEME_SHORT) . '</a></li>';
    $k = 0;
    foreach ($termchildren as $child) 
    {
        $term = get_term_by( 'id', $child, $taxonomyName );
        $k++;
        $html .= '<li><a href="#" data-filter=".' . $term->slug . '">' . $term->name . '</a><span>/</span></li>';
    }
