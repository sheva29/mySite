...
<form action="admin.php?page=<?php echo $menu_slug_3; ?>" method="post">
    ...
    <?php bra_form_text(BRANKIC_VAR_PREFIX."email_from", "Email from field", 400, "", "Insert email address", ""); ?>
    ...
    <?php bra_form_text(BRANKIC_VAR_PREFIX."contact_form_title", "Heading above contact form", 400, "", "Insert heading", ""); ?> 
    
    <?php bra_form_text(BRANKIC_VAR_PREFIX."contact_form_location", "Location if you're using full-width layout", 400, "", "Insert your location", ""); ?>
    
    <?php bra_form_text(BRANKIC_VAR_PREFIX."contact_form_zoom", "Zoom level (if you're using full-width layout", 50, "", "15 is good, less is much wider", ""); ?>
    </tbody>
    </table>
